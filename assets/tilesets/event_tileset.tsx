...
<tileset version="1.10" tiledversion="1.10.1" name="event_tileset" tilewidth="16" tileheight="16" tilecount="400" columns="20">
 <image source="event_tileset.png" width="320" height="320"/>
 <tile id="0">
  <properties>
 ...
 <tile id="8">
  <properties>
   <property name="event" value="BUS"/>
   <property name="type" value="EVENT"/>
  </properties>
 </tile>
 <tile id="9">
  <properties>
   <property name="event" value="GIVE_ENGLISH"/>
   <property name="type" value="EVENT"/>
  </properties>
 </tile>
 <tile id="10">
  <properties>
   <property name="event" value="GIFT_PROF"/>
   <property name="type" value="EVENT"/>
  </properties>
 </tile>
 <tile id="11">
 ...
 <tile id="28">
  <properties>
   <property name="dialog" value="BOOK"/>
   <property name="text" value="取得了&quot;逾期未還的書籍&quot; ，{BR}一直忘記歸還，看是要繳納逾期費了。"/>
   <property name="type" value="DIALOG"/>
  </properties>
 </tile>
 <tile id="29">
 ...
 <tile id="46">
  <properties>
   <property name="dialog" value="EXHIBIT"/>
   <property name="text" value="你在閱讀完產覽後填寫了心得，拿到了一小時的藝文時數{BR}OS:還好之前有搶到CPR"/>
   <property name="type" value="DIALOG"/>
  </properties>
 </tile>
 <tile id="47">
  <properties>
   <property name="dialog" value="COMPUTER"/>
 ...
 <tile id="86">
  <properties>
   <property name="test" value="RETURN_BOOK"/>
 ...
 <tile id="121">
  <properties>
   <property name="dest" value="DORM_INTER"/>
   <property name="type" value="MAP"/>
   <property name="x" type="float" value="9"/>
   <property name="y" type="float" value="9"/>
  </properties>
 </tile>
 <tile id="123">
